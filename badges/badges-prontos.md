## Como usar os Badges?
[Aqui tem um guia para você](https://github.com/nicolaswalcker/project-readme/blob/main/badges/badges-guia.md).
Mas se está com preguiça de entrar, vou explicar rapidamente.
1. Copie o URL do badge.
2. Cole ele `![Nome do Badge](aqui)` ou ` <img src="aqui" /> `.
3. Por fim, cole ele no seu perfil!
